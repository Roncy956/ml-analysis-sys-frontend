<template>
    ...
    <label v-if="showDialog" for="my_modal_vertical_bar_char" class="btn">放大显示</label>

    <!-- Put this part before </body> tag -->
    <input v-if="showDialog" type="checkbox" id="my_modal_vertical_bar_char" class="modal-toggle"/>
    <div v-if="showDialog" class="modal" role="dialog">
        ...
        <label class="modal-backdrop" for="my_modal_vertical_bar_char">Close</label>
    </div>
</template>
